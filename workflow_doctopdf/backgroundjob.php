...
class BackgroundJob extends \OC\BackgroundJob\QueuedJob {
	...
	protected function run($argument) {
		...
		$defaultParameters = ' -env:UserInstallation=file://' . escapeshellarg($tmpDir . '/owncloud-' . $this->config->getSystemValue('instanceid') . '/') . ' --headless --nologo --nofirststartwizard --invisible --norestore --convert-to pdf --outdir ';
